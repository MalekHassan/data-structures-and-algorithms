...
const createServer = () => {
  ...
  var server = app.listen(3301, function () {
   ...
   //hello
   app.get('/hello', (req, responds) => {
    responds.status(200).send('hello');
});
//about me
app.get('/aboutme', (req, responds) => {
    responds.status(200).send('short bio');
});
//favorite foods
app.get('/favoritefoods', (req, responds) => {
    const favoritefood = ['pasta', 'meat', 'milk'];
    responds.status(200).send(favoritefood);
});
//404
app.all('*', (req, responds) => {
    responds.status(404).send('Not Found');
});
